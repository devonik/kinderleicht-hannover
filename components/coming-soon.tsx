...
/** Coming-Soon-/Maintenance-Ansicht (Produktion vor dem Go-Live). */
  ...
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-16 text-center">
      ...
      <div className="relative flex max-w-xl flex-col items-center">
        ...
        <p className="mb-6 text-xs font-medium tracking-[0.3em] text-eucalyptus uppercase">
          Website im Aufbau
        </p>
        ...
        <span aria-hidden className="my-9 block h-px w-16 bg-terracotta/70" />
